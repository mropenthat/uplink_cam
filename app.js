...
(function () {
  ...
  const COUNTRY_CODE_TO_NAME = {
    ...
    RU: "Russia", UA: "Ukraine", BY: "Belarus", JP: "Japan", KR: "South Korea", CN: "China",
    ...
    TW: "Taiwan", AM: "Armenia", NI: "Nicaragua", BD: "Bangladesh", KZ: "Kazakhstan", GE: "Georgia",
    LK: "Sri Lanka", PK: "Pakistan", NG: "Nigeria", KE: "Kenya", MA: "Morocco", TN: "Tunisia",
    IQ: "Iraq", IR: "Iran", JO: "Jordan", LB: "Lebanon", KW: "Kuwait", QA: "Qatar", BH: "Bahrain",
    OM: "Oman", UZ: "Uzbekistan", AZ: "Azerbaijan", KG: "Kyrgyzstan", TJ: "Tajikistan",
    MM: "Myanmar", KH: "Cambodia", LA: "Laos", NP: "Nepal", AF: "Afghanistan",
    UY: "Uruguay", PY: "Paraguay", VE: "Venezuela", BO: "Bolivia", CR: "Costa Rica", GT: "Guatemala",
    SV: "El Salvador", CU: "Cuba", JM: "Jamaica", TT: "Trinidad and Tobago",
    IS: "Iceland", AL: "Albania", ME: "Montenegro", MK: "North Macedonia", XK: "Kosovo",
  };
  ...
  var COUNTRY_ALIASES = { Russia: "RU", "Russian Federation": "RU", Serbia: "RS", Moldova: "MD", "Czechia": "CZ", Taiwan: "TW", "Korea, Republic Of": "KR", "Taiwan, Province Of": "TW" };
  ...
  const COUNTRY_CENTER = {
    ...
    India: [20.6, 78.96], IN: [20.6, 78.96],
    "United States": [37.1, -95.7], US: [37.1, -95.7],
    Ukraine: [48.38, 31.17], UA: [48.38, 31.17],
    Argentina: [-38.42, -63.62], AR: [-38.42, -63.62],
    Germany: [51.17, 10.45], DE: [51.17, 10.45],
    "New Zealand": [-40.9, 174.89], NZ: [-40.9, 174.89],
    Italy: [41.87, 12.57], IT: [41.87, 12.57],
    Mexico: [23.63, -102.55], MX: [23.63, -102.55],
    Netherlands: [52.13, 5.29], NL: [52.13, 5.29],
    Serbia: [44.02, 20.92], RS: [44.02, 20.92],
    Peru: [-9.19, -75.02], PE: [-9.19, -75.02],
    "Russian Federation": [61.52, 105.32], Russia: [61.52, 105.32], RU: [61.52, 105.32],
    Brazil: [-14.24, -51.93], BR: [-14.24, -51.93],
    "United Kingdom": [55.38, -3.44], GB: [55.38, -3.44],
    ...
    Indonesia: [-0.79, 113.92], ID: [-0.79, 113.92],
    Thailand: [15.87, 100.99], TH: [15.87, 100.99],
    "South Africa": [-30.56, 22.94], ZA: [-30.56, 22.94],
    Egypt: [26.82, 30.8], EG: [26.82, 30.8],
    Colombia: [4.57, -74.3], CO: [4.57, -74.3],
    Chile: [-35.68, -71.54], CL: [-35.68, -71.54],
    Romania: [45.94, 24.97], RO: [45.94, 24.97],
    Greece: [39.07, 21.82], GR: [39.07, 21.82],
    Portugal: [39.4, -8.22], PT: [39.4, -8.22],
    Czechia: [49.82, 15.47], CZ: [49.82, 15.47],
    Hungary: [47.16, 19.5], HU: [47.16, 19.5],
    Austria: [47.52, 14.55], AT: [47.52, 14.55],
    Switzerland: [46.82, 8.23], CH: [46.82, 8.23],
    Belgium: [50.5, 4.47], BE: [50.5, 4.47],
    Sweden: [62.2, 17.64], SE: [62.2, 17.64],
    Norway: [60.47, 8.47], NO: [60.47, 8.47],
    Finland: [61.92, 25.75], FI: [61.92, 25.75],
    Croatia: [45.1, 15.2], HR: [45.1, 15.2],
    Slovakia: [48.67, 19.7], SK: [48.67, 19.7],
    Bulgaria: [42.73, 25.49], BG: [42.73, 25.49],
    Philippines: [12.88, 121.77], PH: [12.88, 121.77],
    Vietnam: [14.06, 108.28], VN: [14.06, 108.28],
    Malaysia: [4.21, 101.98], MY: [4.21, 101.98],
    Israel: [31.05, 34.85], IL: [31.05, 34.85],
    "Saudi Arabia": [23.89, 45.08], SA: [23.89, 45.08],
    "United Arab Emirates": [23.42, 53.85], AE: [23.42, 53.85],
    Armenia: [40.07, 45.04], AM: [40.07, 45.04],
    Nicaragua: [12.87, -85.21], NI: [12.87, -85.21],
    Bangladesh: [23.68, 90.36], BD: [23.68, 90.36],
    Kazakhstan: [48.02, 66.92], KZ: [48.02, 66.92],
    Honduras: [15.2, -86.24], HN: [15.2, -86.24],
    Ireland: [53.14, -7.69], IE: [53.14, -7.69],
    "Bosnia and Herzegovina": [43.92, 17.68], BA: [43.92, 17.68],
    Moldova: [47.41, 28.37], MD: [47.41, 28.37],
    Taiwan: [23.7, 120.96], TW: [23.7, 120.96],
    Ecuador: [1.83, -78.18], EC: [1.83, -78.18],
    Panama: [8.54, -80.78], PA: [8.54, -80.78],
    Singapore: [1.35, 103.82], SG: [1.35, 103.82],
    Denmark: [56.26, 9.5], DK: [56.26, 9.5],
    Estonia: [58.6, 25.01], EE: [58.6, 25.01],
    Lithuania: [55.17, 23.88], LT: [55.17, 23.88],
    Latvia: [56.88, 24.6], LV: [56.88, 24.6],
  };
  ...
  var COUNTRY_TO_TZ = {
    ...
    Ukraine: "Europe/Kiev", UA: "Europe/Kiev",
  ...
  function getTimezoneForLocation(locationStr) {
    ...
    if (lastPart && COUNTRY_TO_TZ[lastPart]) return COUNTRY_TO_TZ[lastPart];
